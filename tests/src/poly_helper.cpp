...
TEST(poly_helper, orientation_basic) {
    EXPECT_EQ(_poly_helper_::orientation({0, 0}, {1, 1}, {1, 0}), _poly_helper_::Clockwise);
    EXPECT_EQ(_poly_helper_::orientation({0, 0}, {1, 1}, {0, 1}), _poly_helper_::Counterclockwise);
    EXPECT_EQ(_poly_helper_::orientation({0, 0}, {1, 1}, {.5, .5}), _poly_helper_::Collinear);
}
...
TEST(poly_helper, cross_intersecting) {
    EXPECT_TRUE(_poly_helper_::segments_intersect({0, 0}, {1, 1}, {1, 0}, {0, 1}));
}
